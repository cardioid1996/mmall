...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path){
        ...
        Order order = orderMapper.selectByUserIdaAndOrderNo(userId, orderNo);
        if (order == null){
            return ServerResponse.createByErrorMessage("用户没有该订单");
        }
        resultMap.put("orduerNo", String.valueOf(order.getOrderNo()));
    ...
    public ServerResponse getOrderDetail(Integer userId, Long orderNo){
        ...
        return ServerResponse.createByErrorMessage("该订单不属于此用户！");
    }
    ...
    private long generateOrderNo(){
        // 生成订单号,规则很重要，单纯递增可以轻易让人看出每天的交易量
    ...
    public ServerResponse<PageInfo> manageList(int pageNum, int pageSize){
        ...
        List<OrderVo> orderVoList = this.assembleOrderVoList(orderList, null);  // userId为null
